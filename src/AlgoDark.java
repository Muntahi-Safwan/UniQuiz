...
public class AlgoDark extends JFrame{
    Person p;
   public AlgoDark(Person user){
        this.p = user;
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setTitle("Algo| UniQuiz");
        ...
        JLabel txt1 = new JLabel("Algorithm Quiz");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                AlgoQuizDark algoQuiz = new AlgoQuizDark(user);
