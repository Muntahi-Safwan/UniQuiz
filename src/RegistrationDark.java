...
public class RegistrationDark extends JFrame {
    ...
    public RegistrationDark(){
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setTitle("Sign Up | UniQuiz");
        ...
        ImageIcon blur = new ImageIcon("./assets/Rectangle 4.png");
        ...
        text1.setForeground(new Color(0xB8E4FA));
        ...
        textField1.setForeground(new Color(0x070121));
        ...
        textField2.setForeground(new Color(0x070121));
        ...
        textField3.setForeground(new Color(0x070121));
        textField3.setText("Department");
        ...
        textField4.setForeground(new Color(0x070121));
        ...
        textField5.setForeground(new Color(0x070121));
        ...
        captchaTxt.setForeground(new Color(0xB8E4FA));
