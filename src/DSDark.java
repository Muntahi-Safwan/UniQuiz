...
public class DSDark extends JFrame{
    Person p;
    public DSDark(Person user){
        this.p = user;
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setTitle("DS | UniQuiz");
        ...
        JLabel txt1 = new JLabel("Data Structure Quiz");
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                DSQuizDark dsQuiz = new DSQuizDark(user);
                dsQuiz.setVisible(true);
            }
        });
    ...
    public static void main(String[] args) {
        DSDark ds = new DSDark(new Person("23-53117-3"));
        ds.setVisible(true);
    }
}
