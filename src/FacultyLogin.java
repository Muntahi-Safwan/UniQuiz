...
public class FacultyLogin extends JFrame {
    ...
    public FacultyLogin(){
        ...
        this.setTitle("Faculty Login | UniQuiz");
        ...
        JLabel text1 = new JLabel("Faculty Sign In", JLabel.CENTER);
        text1.setFont(new Font("Verdana", Font.BOLD, 30));
        text1.setForeground(new Color(0x071330));
        text1.setBounds(600, 281, 300, 49);
        ...
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (tf1.isEmpty() || tf2.isEmpty()) {
                    ...
                    try {
                        Faculty createAccount = new Faculty();

			 	if(createAccount.getAccount(tf1, tf2))
				{
					JOptionPane.showMessageDialog(null,"Login Successful");
                    FacultyPanel f = new FacultyPanel();
					setVisible(false);
					f.setVisible(true);
