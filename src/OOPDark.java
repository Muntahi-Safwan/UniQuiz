...
public class OOPDark extends JFrame{
    Person p;
    public OOPDark(Person user){
        this.p = user;
        ...
        txt6.setFont(new Font("5", Font.PLAIN, 18));
        ...
        button1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                OOPQuizDark oopQuiz = new OOPQuizDark(user);
    ...
    public static void main(String[] args) {
        OOPDark oop = new OOPDark(new Person("23-53117-3"));
        oop.setVisible(true);
    }
}
